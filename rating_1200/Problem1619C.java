...
public class Problem1619C {
    ...
    static void solve() throws IOException {
        long a = Long.parseLong(nextToken()), s = Long.parseLong(nextToken());
        ...
        if (a > 0) out.println(-1);
            ...
            for(int i = b.size() - 1; i>=0; i--) sb.append(b.get(i));
            out.println(Long.parseLong(sb.toString()));
        }
    }
